...
class TestSqlAlchemyRepository:
    ...
    async def test_add_one(
        ...
        await sql_rep.add_one(**first_organization)
    ...
    async def test_add_one_and_get_id(
        ...
        sql_rep = self.__get_sql_rep(transaction_session)
        user_id = await sql_rep.add_one_and_get_id(**first_organization)
    ...
    async def test_add_one_and_get_obj(
        ...
        sql_rep = self.__get_sql_rep(transaction_session)
        user = await sql_rep.add_one_and_get_obj(**first_organization)
    ...
    async def test_get_by_filter_one_or_none(
        ...
        with case.expected_error:
            user_in_db: OrganizationModel | None = await sql_rep.get_by_filter_one_or_none(**case.data)
    ...
    async def test_get_by_filter_all(
        ...
        sql_rep = self.__get_sql_rep(transaction_session)
        with case.expected_error:
            users_in_db: Sequence[OrganizationModel] = await sql_rep.get_by_filter_all(**case.data)
    ...
    async def test_update_one_by_id(
        ...
        sql_rep = self.__get_sql_rep(transaction_session)
        with case.expected_error:
            updated_user: OrganizationModel | None = await sql_rep.update_one_by_id(case.data.pop('_id'), **case.data)
